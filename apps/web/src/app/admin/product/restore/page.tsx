...
import FormRestoreProduct from '@/components/formRestore/product';
import { useGetRestoreProduct } from '@/features/restore/hook/product/useGetRestoreProduct';
import Link from 'next/link';

export default function RestoreCategory() {
  const { dataRestoreProduct, isLoading } = useGetRestoreProduct();
      ...
      <div className="p-10">
        ...
        <div>
          {isDebouncing ? (
            ...
            <div>
              <FormRestoreProduct restore={dataRestoreProduct} />
            </div>
          )}
        </div>
      </div>
