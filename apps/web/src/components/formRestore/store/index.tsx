...
import { useRestoreStoreById } from '@/features/restore/hook/store/useRestoreStoreById';
import { useRestoreStore } from '@/features/restore/hook/store/useRestroreStore';
export default function FormRestoreStore({ restore }: any) {
  const { restoreStore } = useRestoreStore();
  const { restoreStoreById } = useRestoreStoreById();
                    ...
                    <button
                      onClick={() => {
                        if (
                          ...
                          restoreStoreById({ storeId: trash.id });
                        }
                      }}
