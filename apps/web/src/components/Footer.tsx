...
export const Footer = () => {
  return (
    <div>
      <footer className="px-4 divide-y bg-[#28b293] text-gray-800">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            <Image
              ...
              height={100}
              alt="logo"
              className="flex-shrink-0 w-[200px] h-[200px] rounded-full text-gray-50"
            />
          </div>
        ...
        <div className="py-6 text-sm text-center text-gray-600 font-bold">
          © JCWD BSD 2702-03 FinPro. All rights reserved.
        </div>
      </footer>
    </div>
  );
